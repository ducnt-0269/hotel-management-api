...
| F-004 | Manage users | — | — | ✅ | |
| F-005 | View room list and room detail | ✅ | ✅ | ✅ | Công khai |
| F-006 | Search available rooms by date range and amenity | ✅ | ✅ | △ | Endpoint công khai nên admin gọi được, nhưng không nằm trong luồng nghiệp vụ của admin — họ dùng F-007 |
...
| F-013 | Review a room already booked | — | △ | — | Chỉ phòng user này thực sự đã ở |
